...
(ert-deftest test-assist-web-has-global-entry-and-thread-local-shortcuts ()
  (should (eq (lookup-key (current-global-map) (kbd "C-t"))
              #'emacos-assist-web-open-thread))
  (should (eq (lookup-key (current-global-map) (kbd "M-t"))
              #'emacos-assist-web-new-thread))
  (should (eq (lookup-key emacos-assist-web-mode-map (kbd "M-d"))
              #'emacos-assist-web-show-diff))
  (should (eq (lookup-key emacos-assist-web-mode-map (kbd "M-f"))
              #'emacos-assist-web-show-files))
  (should (eq (lookup-key emacos-assist-web-mode-map (kbd "M-p"))
